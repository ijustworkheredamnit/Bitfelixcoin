...
import BaseCard from "../../BaseCard"; // plasmic-import: Y-tLFE4-Txn9H/component
...
import * as sty from "./PlasmicPlan.module.css"; // plasmic-import: F0bJTxWOUrVYU/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(defaultcss.all, sty.box__ywfac)}>
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box___8HM2T)}
        >
          <p.PlasmicSlot
          ...
          <p.PlasmicSlot
            defaultContents={
              <p.Stack
                as={"div"}
                hasGap={true}
                className={classNames(defaultcss.all, sty.box__qkl8Y)}
              >
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__xpnBg)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__iUO7)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__fu1Hg)}
                />
              </p.Stack>
            }
          ...
          <div className={classNames(defaultcss.all, sty.box__kwZk)}>
            <p.PlasmicSlot
              defaultContents={
                <LinkButton
                  text={"Get started"}
