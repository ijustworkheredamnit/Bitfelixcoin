...
import Avatar from "../../Avatar"; // plasmic-import: _RShc7ubGIjEp/component
...
import * as sty from "./PlasmicTestimonial.module.css"; // plasmic-import: gjyR5W7314cGj/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: jO9dgcpjg5Vr75/icon
import profilepicRHzNvkEcZyRylG from "./images/profilepic.png"; // plasmic-import: RHzNvkEcZYRylG/picture
  ...
  return (
    ...
    >
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__ubeSi)}
      >
        <div
        ...
        >
          {
            "“ I love Bitfelixcoin and would recommend it to anyone. Could be not easier to use, and our multiple websites are wonderful. We get nice comments all the time. “"
          }
        </div>
        ...
        >
          {"CEO & Co-Founder @Yourmom's Company"}
        </div>
      </p.Stack>
    </div>
