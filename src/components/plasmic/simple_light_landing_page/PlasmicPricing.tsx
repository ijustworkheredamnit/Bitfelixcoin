...
import Plan from "../../Plan"; // plasmic-import: F0bJTxWOUrVYU/component
...
import Faq from "../../Faq"; // plasmic-import: SGZ6RmhAvs-tN/component
...
import * as sty from "./PlasmicPricing.module.css"; // plasmic-import: jz_ePCLIM07Xs/css
      ...
      <div className={defaultcss.plasmic_page_wrapper}>
        ...
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(defaultcss.all, sty.box__fIydt)}
          >
            <Header
            ...
            <Section
              className={classNames("__wab_instance", sty.section__iskYj)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <p.Stack
                    as={"div"}
                    hasGap={true}
                    className={classNames(defaultcss.all, sty.box__lDvZk)}
                  >
                    <Plan
                      className={classNames("__wab_instance", sty.plan__dQpt5)}
                      price={
                        <div
                          className={classNames(
                            defaultcss.all,
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan__w56QW)}
                      description={
                        <p.Stack
                          as={"div"}
                          hasGap={true}
                          className={classNames(defaultcss.all, sty.box__wIcdw)}
                        >
                          <Bullet
                            className={classNames(
                              "__wab_instance",
                    ...
                    <Plan
                      className={classNames("__wab_instance", sty.plan__tfDg)}
                      name={"Enterprise"}
                      price={
                        <div
                          className={classNames(
            ...
            <Section
              className={classNames("__wab_instance", sty.section__cSekk)}
              subtitle={
                <React.Fragment>
                  <div
                    className={classNames(
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__gXbIu)}
                    slot={
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq___9FO7B)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
                  ...
                  <Faq
                    className={classNames("__wab_instance", sty.faq__pcJm5)}
                    slot={
                      "Yes! You can. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat."
                    }
                  >
