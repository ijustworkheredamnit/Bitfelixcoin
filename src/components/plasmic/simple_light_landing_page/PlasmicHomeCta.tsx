...
import * as sty from "./PlasmicHomeCta.module.css"; // plasmic-import: MK42DMIil8ITx/css

import SphereIcon from "./icons/PlasmicIcon__Sphere"; // plasmic-import: jZQ0xPwIGvMe9y/icon
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__sNngy)}
      >
        <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__pz4Eg)}
        >
          <input
      ...
      {(hasVariant(globalVariants, "screen", "mobile") ? false : true) ? (
        <div className={classNames(defaultcss.all, sty.box___5PIZr)}>
          <SphereIcon
