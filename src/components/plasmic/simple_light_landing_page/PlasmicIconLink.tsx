...
import * as sty from "./PlasmicIconLink.module.css"; // plasmic-import: vEbGTJFFsI-tH/css
    ...
    >
      ...
      >
        <p.PlasmicSlot
          defaultContents={
            <svg
              className={classNames(defaultcss.all, sty.svg__hoBc2)}
              role={"img"}
            />
          }
          value={args.icon}
