...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: Y-tLFE4-Txn9H/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__q4Pyc, {
          [sty.box__long__q4PycM5Wp1]: hasVariant(variants, "long", "long")
        })}
      >
        <p.PlasmicSlot
          defaultContents={
      ...
      {(hasVariant(variants, "long", "long") ? true : false) ? (
        <div
          className={classNames(defaultcss.all, sty.box__tz9KP, {
            [sty.box__long__tz9KPm5Wp1]: hasVariant(variants, "long", "long")
          })}
        >
          <p.PlasmicSlot
            defaultContents={
              <svg
                className={classNames(defaultcss.all, sty.svg__wdImj)}
                role={"img"}
              />
            }
            value={args.iconBack}
