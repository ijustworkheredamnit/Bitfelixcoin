...
import * as sty from "./PlasmicFaq.module.css"; // plasmic-import: SGZ6RmhAvs-tN/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__lDf5T)}
      >
        <div className={classNames(defaultcss.all, sty.box__iw69X)}>
          <div className={classNames(defaultcss.all, sty.box__mOmdT)}>
            <p.PlasmicSlot
