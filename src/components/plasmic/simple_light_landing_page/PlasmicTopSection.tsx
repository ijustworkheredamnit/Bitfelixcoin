...
import * as sty from "./PlasmicTopSection.module.css"; // plasmic-import: rCJcx1o55zvK3/css

import logofullpngHdajUrIhy from "./images/logofullpng.png"; // plasmic-import: HdajUrIHY/picture
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__nHuFm)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__fVtBp)}
        >
          <div className={classNames(defaultcss.all, sty.box___68TaE)}>
            <div
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(defaultcss.all, sty.box__mys9L)}
        >
          <LinkButton
            className={classNames("__wab_instance", sty.linkButton___8GntM)}
            href={"https://paypal.me/givemeyourmoney259" as const}
            text={"Download now"}
            type={"solidBlue" as const}
          />

          <LinkButton
            className={classNames("__wab_instance", sty.linkButton__cJhY)}
            href={"https://paypal.me/givemeyourmoney259" as const}
            text={"Learn more"}
        ...
        <div className={classNames(defaultcss.all, sty.box__rA0Kh)}>
          <img
